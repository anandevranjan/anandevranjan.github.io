...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/nl0c03839_0008.gif){: .align-center}

The image above happens to be **centered**.

![image-left]({{ site.url }}{{ site.baseurl }}/assets/images/my_photo.JPG){: .align-left} The rest of this paragraph is filler for the sake of seeing the text wrap around the 150×150 image, which is **left aligned**.
...
![image-right]({{ site.url }}{{ site.baseurl }}"/assets/images/air_trap.jpg"){: .align-right}
